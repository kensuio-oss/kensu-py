...
class UserRef(object):
    ...
    def __init__(self, by_guid=None, by_pk=None):
        """
        UserRef - a model defined in Swagger
        """
    ...
    def by_guid(self, by_guid):
        """
        Sets the by_guid of this UserRef.
        Identify an entity by a server-generated globally-unique-identifier

        :param by_guid: The by_guid of this UserRef.
        :type: str
        """
    ...
    def by_pk(self):
        """
        Gets the by_pk of this UserRef.
        Identify an entity by it's primary key

        :return: The by_pk of this UserRef.
        :rtype: UserPK
        """
        return self._by_pk
    ...
    def by_pk(self, by_pk):
        """
        Sets the by_pk of this UserRef.
        Identify an entity by it's primary key

        :param by_pk: The by_pk of this UserRef.
        :type: UserPK
        """
