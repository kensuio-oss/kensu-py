...
class SchemaRef(object):
    ...
    def __init__(self, by_guid=None, by_pk=None):
        """
        SchemaRef - a model defined in Swagger
        """
    ...
    def by_guid(self):
        """
        Gets the by_guid of this SchemaRef.
        Identify an entity by a server-generated globally-unique-identifier

        :return: The by_guid of this SchemaRef.
        :rtype: str
        """
    ...
    def by_guid(self, by_guid):
        """
        Sets the by_guid of this SchemaRef.
        Identify an entity by a server-generated globally-unique-identifier

        :param by_guid: The by_guid of this SchemaRef.
        :type: str
        """
    ...
    def by_pk(self):
        """
        Gets the by_pk of this SchemaRef.
        Identify an entity by it's primary key

        :return: The by_pk of this SchemaRef.
        :rtype: SchemaPK
        """
        return self._by_pk
    ...
    def by_pk(self, by_pk):
        """
        Sets the by_pk of this SchemaRef.
        Identify an entity by it's primary key

        :param by_pk: The by_pk of this SchemaRef.
        :type: SchemaPK
        """
