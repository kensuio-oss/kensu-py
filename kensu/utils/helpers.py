...
from kensu.utils.kensu_conf_file.conf_file import extract_config_property as extract_config_property_py35, get_conf_path as get_conf_path_py35
...
def extract_config_property(key, default, arg=None, kw=None, conf=None, tpe=None):
    return extract_config_property_py35(key, default, arg=arg, kw=kw, conf=conf, tpe=tpe)


def get_conf_path(default = "conf.ini"):
    return get_conf_path_py35(default = "conf.ini")
